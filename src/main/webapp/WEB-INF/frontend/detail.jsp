                        ...
                        <div class="product_tab fix">
                            <div class="tab-content produc_tab_c">
                                <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                                    <div class="modal_img">
                                        <a href="#"><img src="/images/${requestScope.product.image}" alt=""></a>
                                        <div class="img_icone">
                                            <img src="/frontend/assets\img\cart\span-new.png" alt="">
                                        </div>
                                        <div class="view_img">
                                            <a class="large_view" href="/images/${requestScope.product.image}"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="p_tab2" role="tabpanel">
                                    <div class="modal_img">
                                        ...
                                        <div class="view_img">
                                            <a class="large_view" href="/frontend/assets\img\product\product14.jpg"><i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="p_tab3" role="tabpanel">
                                    <div class="modal_img">
                                        ...
                                        <div class="view_img">
                                            <a class="large_view" href="/frontend/assets\img\product\product15.jpg"> <i class="fa fa-search-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="product_d_right">
                            ...
                            <div class="product_desc">
                                <p>${requestScope.product.title}</p>
                            </div>
