<%@ page import="com.example.casem3.model.Customer" %>
                ...
                <div class="row pos_home">
                    <div class="col-lg-3 col-md-12">
                                ...
                                <ul>
                                    <c:forEach items="${requestScope.categories}" var="c">
                                        <li>
                                            ...
                                            <label for="acces">${c.name}<span>(1)</span></label>
                                        </li>
                                    </c:forEach>
                        ...
                        <div class="sidebar_widget price">
                            ...
                            <div class="ca_search_filters">
                                <form>
                                    <div class="row">
                                        <input type="text" id="amount" name="price" class="col-8">
                                        <button class="col-4 btn btn-primary" type="submit">Submit</button>
                                    </div>
                                </form>
                        ...
                        <div class="sidebar_widget special">
                            ...
                            <div class="special_product_inner mb-20">
                                <div class="special_p_thumb">
                                    <a href="single-product.html"><img src="/frontend/assets\img\cart\cart3.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="special_product_inner">
                                <div class="special_p_thumb">
                                    <a href="single-product.html"><img src="/frontend/assets\img\cart\cart18.jpg" alt=""></a>
                                </div>
                                <div class="small_p_desc">
                                    <div class="product_ratting">
                                        <ul>
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="banner_slider mb-35">
                            <img src="/frontend/assets\img\banner\bannner10.jpg" alt="">
                        </div>
                        <!--banner slider start-->
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="?action=detail&pid=${p.id}"><img src="/images/${p.image}" alt=""></a>
                                                        <div class="img_icone">
                                                    ...
                                                    <div class="product_content">
                                                        ...
                                                        <h3 class="product_title"><a href="?action=detail&id=${p.id}">${p.name}</a></h3>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="list" role="tabpanel">
                                    ...
                                    <div class="product_list_item mb-35">
                                        <div class="row align-items-center">
                                            <div class="col-lg-4 col-md-6 col-sm-6">
                                                <div class="product_thumb">
                                                    <a href="single-product.html"><img src="/frontend/assets\img\product\product5.jpg" alt=""></a>
                                                    <div class="img_icone">
                                                        <img src="/frontend/assets\img\cart\span-new.png" alt="">
                                                    </div>
                                                </div>
...
<%--                                    <button type="submit">submit</button>--%>
                                    <script>
                                        ...
                                        if(document.URL.split("?")[1]!==undefined) {
                                            limit = document.URL.split("?")[1].split("=")[1];
                                        }

                                        document.getElementById("page_select").value = limit;
                                        document.getElementById("page_select").onchange = ()=>{
                                            document.getElementById("setPageLimit").submit();
                                        }
                                    </script>
                                        ...
                                        <c:choose>
                                            <c:when test="${currentPage eq i}">
                                                ...
                                                <li class="page-item active">
                                                    <a href="/?kw=${requestScope.kw}&cid=${requestScope.category}&page=${i}}" class="page-link">${i}</a>
                                                </li>
                                            </c:when>
                                            <c:otherwise>
                                                <li class="page-item">
