            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-end" >
                    <form method="get" action="/products">
                        ...
                        <select name="idCategory" class="form-control" style="width: 200px; display: inline-block" >
                            <option value="-1">ALL</option>
                            <c:forEach items="${requestScope.categories}" var="cate">
                                <option
                                        <c:if test="${requestScope.idCategory == cate.id}">selected</c:if>
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach var="p" items="${requestScope.products}" >
                            <tr>
                                <td>${p.name}</td>
                                <td>
                                    <img src="/images/${p.getImage()}" style="width: 100px; height: auto" >
                                </td>
                                <td>
                                    <c:forEach var="category" items="${requestScope.categories}">
                                        <c:if test="${category.getId()==p.getIdCategory()}">
                                            ${category.getName()}
                                        </c:if>
                                    </c:forEach>
                                </td>
                    ...
                    <div class="row justify-content-end">
                        <ul class="pagination pagination-split float-right mb-0">
                            <c:if test="${currentPage != 1}">
                                <li class="page-item">
                                    <a href="/products?kw=${requestScope.kw}&ct=${requestScope.ct}&page=${currentPage-1}&limit=${limit}" class="page-link"><i class="fa fa-angle-left"></i></a>
                                </li>
                            </c:if>
                                ...
                                <c:choose>
                                    <c:when test="${currentPage eq i}">
                                        <li class="page-item active">
                                            <a href="/products?kw=${requestScope.kw}&ct=${requestScope.ct}&page=${i}&limit=${limit}" class="page-link">${i}</a>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                                        <li class="page-item">
