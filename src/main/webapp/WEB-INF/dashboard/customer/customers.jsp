                            ...
                            <form method="get" action="/customers">
                                ...
                                <select name="ct" class="form-control" style="width: 200px; display: inline-block" >
                                    ...
                                    <c:forEach items="${requestScope.roles}" var="roles">
                                        <option
                                                <c:if test="${requestScope.idRole == roles.id}">selected</c:if>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:forEach var="role" items="${requestScope.roles}">
                                                <c:if test="${role.getId()==c.getIdRole()}">
                                                    ${role.getName()}
                                                </c:if>
                                            </c:forEach>
                                        </td>
                        ...
                        <div class="row justify-content-end">
                            <ul class="pagination pagination-split float-right mb-0">
                                <c:if test="${currentPage != 1}">
                                    <li class="page-item">
                                        <a href="/customers?kw=${requestScope.kw}&ct=${requestScope.ct}&page=${currentPage-1}&limit=${limit}" class="page-link"><i class="fa fa-angle-left"></i></a>
                                    </li>
                                </c:if>
                                    ...
                                    <c:choose>
                                        <c:when test="${currentPage eq i}">
                                            <li class="page-item active">
                                                <a href="/customers?kw=${requestScope.kw}&ct=${requestScope.ct}&page=${i}&limit=${limit}" class="page-link">${i}</a>
                                            </li>
                                        </c:when>
                                        <c:otherwise>
                                            <li class="page-item">
